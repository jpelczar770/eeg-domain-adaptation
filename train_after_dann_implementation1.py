...
for TARGET_HOSPITAL_CODE in MY_TARGET_HOSPITALS:
    ...
    test_loader = Loader(data_pth, test_pool, minet_subsampling_n=None, num_workers=4).get_batched_loader(batch_size=1, pad=True)
