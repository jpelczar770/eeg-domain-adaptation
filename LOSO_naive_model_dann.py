...
import random
import copy # Zmieniono/dodano w celu poprawnego użycia przy Early Stoppingu
import numpy as np
import pandas as pd
...
# ==========================================
# Generowanie unikalnej nazwy folderu dla wszystkich eksperymentów z tego uruchomienia
...
for TARGET_HOSPITAL_CODE in MY_TARGET_HOSPITALS:
    ...
    test_loader = Loader(
        data_pth, test_pool, minet_subsampling_n=None, num_workers=0 # Zmieniono na 0 dla bezpieczeństwa
    ...
    def evaluate_comprehensive(model, source_loader, target_loader, device, max_batches=100, prefix=""):
        ...
        print("   -> Source...")
        collect_from_loader(train_loader, is_target_domain=False)
        print("   -> Target...")
        collect_from_loader(test_loader, is_target_domain=True)
